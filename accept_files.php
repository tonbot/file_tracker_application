...
<head>
    ...
    <script src="resources/customJs/accept_files.js"></script>
   <style>
               #displayMessage{
               width:25%;
               margin-top:20px;
            ...
            <div class="col-lg-10 secondCol bg-light">
                ...
                <!--top nav ends here -->
                   <div class="section2Container">
                       ...
                       <div class="searchTitle"><span>Search File To Accept</span</div>
                      ...
                      <div class='hasChildren2'><!-- has children 2 -->
                            ...
                            <div class="row">
                                <div class="col-sm-4 titles">
                                    <label for="">Accepting by</label>
                                    <input class="form-control" type="text"  id="accepting_by" readonly>
                                </div>
                                <div class="col-sm-4 first_name">
                                    <label for="">Sent by</label>
                                    <input class="form-control" type="text" name="sent_by" id="sent_by" readonly>
                                </div>
                                <div class="col-sm-4 middle_name">
                                    <label for="">Accepting Officer</label>
                                    <input class="form-control" type="text" name="sending_officer" id="accepting_officer" readonly>
                                </div>                            
                            </div>
